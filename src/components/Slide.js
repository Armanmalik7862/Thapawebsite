...
const Slide = ({ img, title, mainTitle, price }) => {
  return (
    <div className=" w-full  max-h-screen py-1 outline-none border-none relative overflow-hidden">
      <div className="absolute left-[30px] md:left-[70px] max-w-screen sm:max-w-[350px] top-[50%] -translate-y-[50%] space-y-2 lg:space-y-4 bg-[#ffffffa2] sm:bg-transparent p-4 sm:p-0 rounded-lg sm:rounded-none">
      ...
      <Image
        className=" md:h-auto rounded-xl object-cover object-right md:object-left-bottom"
        src={img}
        alt="banner"
        width={2000}
        height={2000}
